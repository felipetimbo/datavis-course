function Network() {
  ...
  function setupData(data) {
    ...
    data.links.forEach(function(l) {
      ...
      (l.source.num_links === undefined) ? l.source.num_links = 1 : l.source.num_links++ ;
      (l.target.num_links === undefined) ? l.target.num_links = 1 : l.target.num_links++ ;
    ...
    data.nodes.forEach(function(n) {
      ...
      n.radius = circleRadius(n.num_links);
    });
  ...
  function showDetails(d, i) {
    var content;
    content = '<p class="main">' + '<b>Character</b>: ' + d.id + '</span></p>';
    content += '<hr class="tooltip-hr">';
    content += '<p class="main">' + '<b> Conections: </b>' + d.num_links + '</span></p>';
  ...
  network = function(selection, data) {
    ...
    force.on("tick", forceTick).charge(-300).linkDistance(100);
